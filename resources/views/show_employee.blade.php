                            ...
                            <div class="pt-8">
                                ...
                                <div class="mt-6">
                                    ...
                                    @for ($i = 0; $i < count(json_decode($employee->wife)); $i++)
                                        <fieldset class="mb-8">
                                            ...
                                            ">
                                                <div class="sm:col-span-3">
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="text" name="name_wife_{{ $i + 1 }}"
                                                            id="name_wife_{{ $i + 1 }}" autocomplete="" class="
                                                            shadow-sm
                                                            focus:ring-indigo-500
                                                            focus:border-indigo-500
                                                            block
                                                ...
                                                <div class="sm:col-span-3">
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="text" name="ic_wife_{{ $i + 1 }}"
                                                            id="ic_wife_{{ $i + 1 }}" autocomplete="" class="
                                                            shadow-sm
                                                            focus:ring-indigo-500
                                                            focus:border-indigo-500
                                                            block
                                                ...
                                                <div class="sm:col-span-3">
                                                    <label for="phone_num_wife_{{ $i + 1 }}" class="
                                                        block
                                                        text-sm
                                                        font-medium
                                                        text-gray-700
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="text" name="phone_num_wife_{{ $i + 1 }}"
                                                            id="phone_num_wife_{{ $i + 1 }}" autocomplete="" class="
                                                            shadow-sm
                                                            focus:ring-indigo-500
                                                            focus:border-indigo-500
                                                            block
                                        ...
                                        @for ($i = 0; $i < count(json_decode($employee->child)); $i++) <fieldset
                                                class="mt-8">
                                                <legend class="
                                                text-base
                                                font-medium
                                            ...
                                            ">
                                                    <div class="sm:col-span-3">
                                                        <label for="name_child_{{ $i + 1 }}" class="
                                                        block
                                                        text-sm
                                                        font-medium
                                                        text-gray-700
                                                    ">
                                                        ...
                                                        <div class="mt-1">
                                                            <input type="text" name="name_child_{{ $i + 1 }}"
                                                                id="name_child_{{ $i + 1 }}" autocomplete="" class="
                                                            shadow-sm
                                                            focus:ring-indigo-500
                                                            focus:border-indigo-500
                                                            block
                                                    ...
                                                    ">
                                                        ...
                                                        <div class="mt-1">
                                                            <input type="text" name="ic_child_{{ $i + 1 }}"
                                                                id="ic_child_{{ $i + 1 }}" autocomplete="" class="
                                                            shadow-sm
                                                            focus:ring-indigo-500
                                                            focus:border-indigo-500
                                                            block
                                                    ...
                                                    <div class="sm:col-span-3">
                                                        <label for="phone_num_child_{{ $i + 1 }}" class="
                                                        block
                                                        text-sm
                                                        font-medium
                                                        text-gray-700
                                                    ">
                                                        ...
                                                        <div class="mt-1">
                                                            <input type="text" name="phone_num_child_{{ $i + 1 }}"
                                                                id="phone_num_child_{{ $i + 1 }}" autocomplete="" class="
                                                            shadow-sm
                                                            focus:ring-indigo-500
                                                            focus:border-indigo-500
                                                            block
