                    ...
                    <form>
                        <div class="space-y-8 divide-y divide-gray-200">
                                ...
                                >
                                    <div class="sm:col-span-6">
                                        ...
                                        <div class="sm:col-span-6 mt-3">
                                            <a
                                                href="{{ asset('/storage/images/'. $employee->image) }}"
                                                target="_blank"
                                            >
                                                <img
                            ...
                            <div class="pt-8">
                                ...
                                <div class="mt-6">
                                    @for ($i = 0; $i <
                                    count(json_decode($employee->wife)); $i++)
                                    <fieldset class="mb-8">
                                        <legend
                                            class="
                                                text-base
                                    ...
                                    @endfor @for ($i = 0; $i <
                                    count(json_decode($employee->child)); $i++)
                                    <fieldset class="mt-8">
                                        <legend
                                            class="
                                                text-base
