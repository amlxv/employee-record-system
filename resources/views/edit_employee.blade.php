                                            ...
                                            <div class="mt-1">
                                                <input
                                                    ...
                                                    class="
                                                        ...
                                                        rounded-md
                                                    "
                                                    value="{{ $employee->phone_num ?? old('phone_num') }}"
                                                />
                                            </div>
                                        </div>
                                            ...
                                            <div class="mt-1">
                                                <input
                                                    ...
                                                    class="
                                                        ...
                                                        rounded-md
                                                    "
                                                    value="{{ $employee->position ?? old('position') }}"
                                                />
                                            </div>
                                        </div>
                                            ...
                                            <div class="mt-1">
                                                <input
                                                    ...
                                                    class="
                                                        ...
                                                        rounded-md
                                                    "
                                                    value="{{ $employee->department ?? old('department') }}"
                                                />
                                            </div>
                                        </div>
                                        <div class="sm:col-span-2">
                                            ...
                                            <div class="mt-1">
                                                <input
                                                    ...
                                                    class="
                                                        ...
                                                        rounded-md
                                                    "
                                                    value="{{ $employee->retiring_num ?? old('retiring_num') }}"
                                                />
                                            </div>
                                        </div>
                                            ...
                                            <div class="mt-1">
                                                <input
                                                    ...
                                                    class="
                                                        ...
                                                        rounded-md
                                                    "
                                                    value="{{ $employee->retiring_date ?? old('retiring_date') }}"
                                                />
                                            </div>
                                        </div>
...
<script>
    ...
    function setWife() {
        ...
        for (let i = 1; i <= wifeCount; i++) {
            ...
            if (wife.length > i - 1) {
                $(`#name_wife_${i}`).val(wife[i - 1]["name"]);
                $(`#ic_wife_${i}`).val(wife[i - 1]["ic"]);
                $(`#phone_num_wife_${i}`).val(wife[i - 1]["phone_num"]);
                $(`#address_wife_${i}`).val(wife[i - 1]["address"]);
            }
        }
    }

    function setChild() {
        let child = JSON.parse($("#employee_child").val());
        ...
        for (let i = 1; i <= childCount; i++) {
            ...
            if (child.length > i - 1) {
                $(`#name_child_${i}`).val(child[i - 1]["name"]);
                $(`#ic_child_${i}`).val(child[i - 1]["ic"]);
                $(`#phone_num_child_${i}`).val(child[i - 1]["phone_num"]);
                $(`#address_child_${i}`).val(child[i - 1]["address"]);
            }
        }
    }
</script>
